...
RMDB_PORT = os.environ.get("RMDB_PORT", "8765")
...
def run_test(test_case):
    ...
    os.system(f"./bin/rmdb -p {RMDB_PORT} " + database_name + " &")
    ...
    time.sleep(3)
    os.system(f"./bin/concurrency_test -p {RMDB_PORT} " + test_file + " " + database_name + "/client_output.txt")
